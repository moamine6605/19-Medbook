    ...
    <div className="register-container">
            ...
            <div className="register-form-container">
                <div className="register-form-wrapper">
                    ...
                    <div className={["card", "register-card"].filter(Boolean).join(" ")}>
                  ...
                  "register-input"].filter(Boolean).join(" ")} type="text" placeholder="Jean Dupont" value={formData.fullName} onChange={(e) => updateField('fullName', e.target.value)} />
                  ...
                  "register-input"].filter(Boolean).join(" ")} type="email" placeholder="vous@exemple.com" value={formData.email} onChange={(e) => updateField('email', e.target.value)} />
                  ...
                  "register-input"].filter(Boolean).join(" ")} type="tel" placeholder="+33 6 00 00 00 00" value={formData.phone} onChange={(e) => updateField('phone', e.target.value)} />
                  ...
                  "register-input-password"].filter(Boolean).join(" ")} type={showPassword ? 'text' : 'password'} placeholder="Créez un mot de passe" value={formData.password} onChange={(e) => updateField('password', e.target.value)} />
                  ...
                  "register-input"].filter(Boolean).join(" ")} type="password" placeholder="Entrez à nouveau votre mot de passe" value={formData.confirmPassword} onChange={(e) => updateField('confirmPassword', e.target.value)} />
